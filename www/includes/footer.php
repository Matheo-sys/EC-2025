...
<footer class="footer">
    <div class="container">
        <div class="row g-4"> <!-- Utilisation du système de grille Bootstrap -->
            <!-- Colonne 1 -->
            <div class="col-12 col-md-4 mb-4 mb-md-0">
                <div class="footer-col">
                    <h4 class="mb-3"> À propos de ParisSport+</h4>
                    <p>ParisSport+ est votre guide de confiance pour trouver des terrains de sport gratuits à Paris. Que
                        vous soyez amateur ou professionnel, nous vous aidons à accéder facilement à des espaces
                        sportifs de qualité, sans frais. Rejoignez-nous pour une pratique sportive accessible à tous !
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4 mb-4 mb-md-0">
                <div class="footer-col">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="terms.php" class="text-decoration-none">Conditions d'utilisation</a>
                        </li>
            ...
            <div class="col-12 col-md-4">
                <div class="footer-col">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="mailto:parissport@alwaysdata.net"
                                class="text-decoration-none">parissport@alwaysdata.net</a></li>
                        <li class="mb-2"><a href="contact.php" class="text-decoration-none">Contact</a></li>
                        <li class="mt-3">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"
    nonce="<?= $nonce ?>"></script>
<script src="https://kit.fontawesome.com/a076d05399.js" crossorigin="anonymous" nonce="<?= $nonce ?>"></script>
